local _2afile_2a = ".config/nvim/fnl/config/plugin/lspconfig.fnl"
...
lsp.pyright.setup({on_attach = on_attach, handlers = handlers, capabilities = capabilities})
return lsp.bashls.setup({on_attach = on_attach, handlers = handlers, capabilities = capabilities})