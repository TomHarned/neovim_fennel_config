local _2afile_2a = "/home/theuser/.config/nvim/fnl/config/plugin/telescope.fnl"
...
nvim.set_keymap("n", "<leader>rg", ":lua require('telescope.builtin').live_grep()<CR>", {noremap = true})
